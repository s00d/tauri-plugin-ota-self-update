            ...
            sections: [
              ...
              },
              {
                ...
                code: {
                  language: 'bash',
                  value:
                    'OTA_PUBLISH_MODE=server OTA_CHANNEL=stable OTA_VERSION=0.2.2 OTA_BASE_URL=http://localhost:9033 OTA_SERVER_TOKEN=dev-token pnpm run ota:publish'
                }
              },
              {
